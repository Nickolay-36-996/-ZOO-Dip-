...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const vectorLeft = document.querySelector(
    ".new__products__slider__vector__left"
  );
  const vectorRight = document.querySelector(
    ".new__products__slider__vector__right"
  );
  ...
  function createCards() {
    ...
    for (const product of cardsData) {
      ...
      card.className = "new__products__card";
      ...
      if (
        ...
        quantityOptions = product.countitemproduct_set
          .map((item) => {
            return `<span class="new__products__card__quantity" 
      ...
      card.innerHTML = `
        <div class="new__products__card__info">
        ${
          discountPercent > 0
            ? `
      <div class="new__product__sale__badge">Акция</div>`
        ...
        <div class="new__products__card__quantity__container">
          <div class="new__products__card__quantity__box">
            ${
              quantityOptions ||
              '<span class="new__products__card__quantity">1 шт.</span>'
            }
          </div>
        </div>
        <div class="new__products__card__pay">
          <div class="new__products__card__pay__price">
            ${
              discountPercent > 0
                ? `
                <div class="new__products__card__pay__price__box">
                  <p class="new__products__card__pay__price__old">${displayOldPrice} BYN</p>
            ...
            <button class="new__products__card__basked__add" data-product-id="${
              ...
              <div class="new__products__card__basket__img__box">
                ...
                <div class="new__product__card__photo__box">
                  <svg class="new__product__card__plus__img" width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button class="new__products__card__pay__btn">Купить в 1 клик</button>
        </div>`;

      container.appendChild(card);

      const quantityBox = card.querySelector(
        ".new__products__card__quantity__box"
      );
        ...
        for (let element of quantityElements) {
          element.addEventListener("click", function () {
            ...
            quantityElements.forEach((el) =>
              el.classList.remove("new__products__card__quantity__active")
            );
  ...
  function buyClick(cardsData) {
    ...
    for (const buyItem of buyItems) {
      buyItem.addEventListener("click", function (e) {
        ...
        const cardId = card
          .querySelector(".new__products__card__basked__add")
